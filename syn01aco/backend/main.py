...
VULN_DB: Dict[str, dict] = {
    ...
    "dirty_cow":                 {"id":"dirty_cow","label":"LS02",                "name":"Dirty COW (CVE-2016-5195)",             "cve":"CVE-2016-5195","severity":"critical", "vm_types":["linux","ubu"]},
    ...
    "rpcbind_exposed":           {"id":"rpcbind_exposed","label":"LC14",          "name":"RPC Portmapper Exposed",                "cve":"CWE-284",      "severity":"low",      "vm_types":["linux","ubu","db"]},
    ...
    # ── Windows Clients ───────────────────────────────────────────────────
    "eternal_blue":              {"id":"eternal_blue","label":"WC01",             "name":"EternalBlue (CVE-2017-0144)",            "cve":"CVE-2017-0144","severity":"critical", "vm_types":["windows","win10","addc"]},
    ...
    "defender_disabled":         {"id":"defender_disabled","label":"WC08",        "name":"Windows Defender Disabled",             "cve":"CWE-693",      "severity":"high",     "vm_types":["windows","win10"]},
    ...
    "lc15_dirty_cow":        {"id":"lc15_dirty_cow",        "label":"LC15","script":"dirty_cow",        "name":"Dirty COW Simulation",                   "cve":"CVE-2016-5195","severity":"critical","vm_types":["linux","ubu"]},
    # ── ADDC alias ────────────────────────────────────────────────────────
