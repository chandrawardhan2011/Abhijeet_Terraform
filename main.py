...
VULN_DB: Dict[str, dict] = {
    ...
    "cronjob_misconfig":         {"id":"cronjob_misconfig","label":"LS04","script":"cronjob_misconfig",        "name":"Cronjob Misconfiguration",              "cve":"CWE-732",      "severity":"high",     "vm_types":["linux","ubu","web","db","ftp","wazuh"]},
    "weak_file_permissions":     {"id":"weak_file_permissions","label":"LS07","script":"weak_file_permissions",    "name":"Weak File Permissions",                 "cve":"CWE-732",      "severity":"medium",   "vm_types":["linux","ubu","web","db","ftp","wazuh"]},
    "unpatched_kernel":          {"id":"unpatched_kernel","label":"LS08","script":"unpatched_kernel",         "name":"Unpatched Kernel / ASLR Disabled",      "cve":"CWE-693",      "severity":"critical", "vm_types":["linux","wazuh"]},
    "suid_binary":               {"id":"suid_binary","label":"LS09","script":"suid_binary",              "name":"SUID Binary Misconfiguration",          "cve":"CWE-250",      "severity":"high",     "vm_types":["linux","ubu","web","db","ftp","wazuh"]},
    "nfs_misconfiguration":      {"id":"nfs_misconfiguration","label":"LS10","script":"nfs_misconfiguration",     "name":"NFS no_root_squash Misconfiguration",   "cve":"CWE-732",      "severity":"high",     "vm_types":["linux","ubu","web","db","ftp","wazuh"]},
    "plain_text_creds":          {"id":"plain_text_creds","label":"LS11","script":"plain_text_creds",         "name":"Plaintext Credentials in Config",       "cve":"CWE-312",      "severity":"high",     "vm_types":["linux","web","db"]},
    ...
    "log_tampering":             {"id":"log_tampering","label":"LS13","script":"log_tampering",            "name":"Log Tampering / Audit Disabled",        "cve":"CWE-778",      "severity":"medium",   "vm_types":["linux","ubu","web","db","ftp","wazuh"]},
    "insecure_service_config":   {"id":"insecure_service_config","label":"LS14","script":"insecure_service_config",  "name":"Insecure Service Configuration",        "cve":"CWE-16",       "severity":"low",      "vm_types":["web"]},
    # ── Linux — client specific ───────────────────────────────────────────

    "weak_passwords":            {"id":"weak_passwords","label":"LC05","script":"weak_passwords",           "name":"Weak User Passwords",                   "cve":"CWE-521",      "severity":"medium",   "vm_types":["linux","ubu"]},
    "no_host_firewall":          {"id":"no_host_firewall","label":"LC07","script":"no_host_firewall",         "name":"No Host Firewall",                      "cve":"CWE-284",      "severity":"medium",   "vm_types":["linux","ubu"]},
    "kernel_hardening_disabled": {"id":"kernel_hardening_disabled","label":"LC08","script":"kernel_hardening_disabled","name":"Kernel Hardening Disabled",             "cve":"CWE-693",      "severity":"critical", "vm_types":["linux","ubu"]},
    "insecure_bash_history":     {"id":"insecure_bash_history","label":"LC09","script":"insecure_bash_history",    "name":"Sensitive Data in Bash History",        "cve":"CWE-312",      "severity":"low",      "vm_types":["linux","ubu","web","db","ftp"]},
    "lxd_privesc":               {"id":"lxd_privesc","label":"LC10","script":"lxd_privesc",              "name":"LXD Group Privilege Escalation",        "cve":"CWE-269",      "severity":"critical", "vm_types":["linux","ubu"]},
    "exposed_api_keys":          {"id":"exposed_api_keys","label":"LC11","script":"exposed_api_keys",         "name":"Exposed API Keys in Environment",       "cve":"CWE-312",      "severity":"high",     "vm_types":["linux","ubu"]},
    "netcat_backdoor":           {"id":"netcat_backdoor","label":"LC12","script":"netcat_backdoor",          "name":"Netcat Backdoor (4444/1337)",            "cve":"CWE-912",      "severity":"critical", "vm_types":["linux","ubu"]},

    # ── Linux — server specific ───────────────────────────────────────────
    "sql_injection":             {"id":"sql_injection","label":"VL01","script":"sql_injection",            "name":"SQL Injection (OWASP A03)",              "cve":"OWASP-A03",    "severity":"critical", "vm_types":["web"]},
    # ── Windows Clients ───────────────────────────────────────────────────

    "weak_admin_password":       {"id":"weak_admin_password","label":"WC04","script":"weak_admin_password",      "name":"Weak Administrator Password",           "cve":"CWE-521",      "severity":"high",     "vm_types":["windows","win10"]},
    "powershell_unrestricted":   {"id":"powershell_unrestricted","label":"WC07","script":"powershell_unrestricted",  "name":"PowerShell Unrestricted + AMSI Off",    "cve":"CWE-78",       "severity":"high",     "vm_types":["windows","win10"]},

    "smb_signing_off":           {"id":"smb_signing_off","label":"WC10","script":"smb_signing_off",          "name":"SMB Signing Disabled",                  "cve":"CWE-300",      "severity":"medium",   "vm_types":["windows","win10","addc"]},
    "local_admin_everyone":      {"id":"local_admin_everyone","label":"WC11","script":"local_admin_everyone",     "name":"Everyone in Local Administrators",      "cve":"CWE-269",      "severity":"high",     "vm_types":["windows","win10"]},
    "windows_update_disabled":   {"id":"windows_update_disabled","label":"WC12","script":"windows_update_disabled",  "name":"Windows Update Disabled",               "cve":"CWE-693",      "severity":"low",      "vm_types":["windows","win10"]},
    # ── Windows Clients — additional ─────────────────────────────────────
    # ── Linux client aliases (different label, same script) ─────────────

    # ── ADDC alias ────────────────────────────────────────────────────────
    # ── Windows Server / ADDC — additional ──────────────────────────────
    "protected_users_disabled":  {"id":"protected_users_disabled", "label":"AD13","script":"protected_users_disabled","name":"Protected Users Not Enforced",       "cve":"CWE-522","severity":"high",    "vm_types":["addc"]},
    "admin_shares_exposed":      {"id":"admin_shares_exposed",      "label":"AD14","script":"admin_shares_exposed","name":"Administrative Shares Exposed",       "cve":"CWE-284","severity":"medium",  "vm_types":["addc"]},
    # ── Windows Server / ADDC ─────────────────────────────────────────────
    "kerberoasting":             {"id":"kerberoasting","label":"AD01","script":"kerberoasting",            "name":"Kerberoasting — Weak SPNs",             "cve":"CWE-522",      "severity":"critical", "vm_types":["addc"]},
    "asrep_roasting":            {"id":"asrep_roasting","label":"AD02","script":"asrep_roasting",           "name":"AS-REP Roasting — No Pre-Auth",         "cve":"CWE-522",      "severity":"high",     "vm_types":["addc"]},
    "dcsync":                    {"id":"dcsync","label":"AD03","script":"dcsync",                   "name":"DCSync — Replication Rights",           "cve":"CWE-269",      "severity":"critical", "vm_types":["addc"]},
    "password_spray_target":     {"id":"password_spray_target","label":"AD07","script":"password_spray_target",    "name":"Password Spray Target",                 "cve":"CWE-521",      "severity":"medium",   "vm_types":["addc"]},
    "golden_ticket_target":      {"id":"golden_ticket_target","label":"AD05","script":"golden_ticket_target",     "name":"Golden Ticket — Weak KRBTGT",           "cve":"CWE-522",      "severity":"critical", "vm_types":["addc"]},
    "domain_user_enum":          {"id":"domain_user_enum","label":"AD06","script":"domain_user_enum",         "name":"Unauthenticated LDAP/SAM Enum",         "cve":"CWE-200",      "severity":"low",      "vm_types":["addc"]},
    "weak_gpo":                  {"id":"weak_gpo","label":"AD04","script":"weak_gpo",                 "name":"Weak Group Policy",                     "cve":"CWE-521",      "severity":"medium",   "vm_types":["addc"]},
    "ad_recycle_disabled":       {"id":"ad_recycle_disabled","label":"AD08","script":"ad_recycle_disabled",      "name":"AD Auditing Disabled",                  "cve":"CWE-778",      "severity":"low",      "vm_types":["addc"]},
    "ntlm_relay_target":         {"id":"ntlm_relay_target","label":"AD09","script":"ntlm_relay_target",        "name":"NTLM Relay — SMB/LDAP Signing Off",     "cve":"CWE-300",      "severity":"high",     "vm_types":["addc"]},
    "unconstrained_delegation":  {"id":"unconstrained_delegation","label":"AD10","script":"unconstrained_delegation", "name":"Unconstrained Kerberos Delegation",     "cve":"CWE-522",      "severity":"critical", "vm_types":["addc"]},
    "shadow_credentials":        {"id":"shadow_credentials","label":"AD11","script":"shadow_credentials",       "name":"Shadow Credentials",                    "cve":"CWE-287",      "severity":"high",     "vm_types":["addc"]},
    "replication_exposed":       {"id":"replication_exposed","label":"AD12","script":"replication_exposed",      "name":"Domain Replication Exposed",            "cve":"CWE-269",      "severity":"critical", "vm_types":["addc"]},
    # ── Scenario Scripts ─────────────────────────────────────────────────────
    ...
    "lc01_dirty_cow":            {"id":"lc01_dirty_cow","label":"LC01","script":"dirty_cow","name":"Dirty COW / ASLR Disabled","cve":"CVE-2016-5195","severity":"critical","vm_types":["ubu"]},
    "dirty_cow":                 {"id":"dirty_cow",                   "label":"LS02","script":"dirty_cow",                  "name":"Dirty COW / ASLR Disabled",             "cve":"CVE-2016-5195", "severity":"critical", "vm_types":["ubu"]},
    ...
    # ── Linux Servers only ───────────────────────────────────────────────────
    "mysql_brute_force":         {"id":"mysql_brute_force",           "label":"LS05","script":"mysql_brute_force",         "name":"MySQL Remote Root",                     "cve":"CWE-521",       "severity":"critical", "vm_types":["db"]},
    "ftp_anonymous":             {"id":"ftp_anonymous",               "label":"LS06","script":"ftp_anonymous",             "name":"FTP Anonymous Login",                   "cve":"CWE-284",       "severity":"medium",   "vm_types":["ftp"]},
    # ── Scenario Scripts ─────────────────────────────────────────────────────
...
def classify_vm(name):
    ...
    if "addc" in n: return "addc"
    if "kali" in n: return "kali"
    if "wazuh" in n: return "wazuh"
    if "ftp" in n: return "ftp"
    if "db" in n: return "db"
    if "web" in n: return "web"
