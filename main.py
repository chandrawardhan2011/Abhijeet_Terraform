...
VULN_DB: Dict[str, dict] = {
    ...
    "cronjob_misconfig":         {"id":"cronjob_misconfig","label":"LS04","script":"cronjob_misconfig",        "name":"Cronjob Misconfiguration",              "cve":"CWE-732",      "severity":"high",     "vm_types":["linux","web","db","ftp"]},
    ...
    "nfs_misconfiguration":      {"id":"nfs_misconfiguration","label":"LS10","script":"nfs_misconfiguration",     "name":"NFS no_root_squash Misconfiguration",   "cve":"CWE-732",      "severity":"high",     "vm_types":["linux","db"]},
    ...
    "open_ports":                {"id":"open_ports","label":"LS12","script":"open_ports",               "name":"Unnecessary Open Ports / No Firewall",  "cve":"CWE-284",      "severity":"medium",   "vm_types":["linux","web","db","ftp","wazuh"]},
    "log_tampering":             {"id":"log_tampering","label":"LS13","script":"log_tampering",            "name":"Log Tampering / Audit Disabled",        "cve":"CWE-778",      "severity":"medium",   "vm_types":["linux","web","db","ftp"]},
    ...
    "insecure_bash_history":     {"id":"insecure_bash_history","label":"LC09","script":"insecure_bash_history",    "name":"Sensitive Data in Bash History",        "cve":"CWE-312",      "severity":"low",      "vm_types":["linux","ubu"]},
